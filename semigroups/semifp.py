'''
This module contains the classes for FpSemigroups and FpMonoids.
'''
# pylint: disable = no-member, len-as-condition
import libsemigroups

class FpSemigroup(libsemigroups.FpSemigroupNC,libsemigroups.Semigroup):
    '''
    A *finitely presented semigroup* is a quotient of a free semigroup on
    a finite number of generators over a finitely generated congruence on
    the free semigroup.
    ...
    def __init__(self, alphabet, rels):
        ...
        elif not all(alphabet.count(i) == 1
                     for i in alphabet):
